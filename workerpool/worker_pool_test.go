...
// before all block will do BeforeEach
// before all block and after BeforeEach will do JustBeforeEach
var _ = Describe("WorkerPool", func() {
	...
	Describe("Start", func() {
		...
		JustBeforeEach(func() {
			close(wp.Tasks()) // close task channel to inform task done and shutdown
